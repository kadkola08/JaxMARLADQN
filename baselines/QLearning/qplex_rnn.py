...
class DuelingRNNQNetwork(nn.Module):
    """
        ...
        def _update_step(runner_state, unused):
            ...
            def _learn_phase(carry, _):
                ...
                def _loss_fn(params):
                    ...
                    qplex_next = mixer.apply(train_state.target_network_params['mixer'], q_next, minibatch.obs["__all__"])
                    qplex_target = (
                    ...
                    qplex = mixer.apply(params['mixer'], chosen_action_q_vals, minibatch.obs["__all__"])[:-1]
                    loss = jnp.mean(
