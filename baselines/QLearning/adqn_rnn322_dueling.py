...
class RNNQNetwork(nn.Module):
    ...
    def __call__(self, hidden, obs, dones):
        ...
        # q_vals = value + (advs - advs.max(axis=-1, keepdims=True))
        q_vals = value + (advs - advs.mean(axis=-1, keepdims=True))
...
class MixingNetwork(nn.Module):
    ...
    @nn.compactmyuser@bcbaf46bb9b6:~$ python baselines/QLearning/covdn_rnn2.py +alg=ql_rnn_mabrax 
    ...
    def train(rng):
        ...
        def get_greedy_metrics(rng, train_state):
            ...
            def _greedy_env_step(step_state, unused):
                ...
                hstate, value, advs = jax.vmap(network.apply, in_axes=(None, 0, 0, 0))(
                    params,
                    hstate,
                    _obs,
                    _dones,
