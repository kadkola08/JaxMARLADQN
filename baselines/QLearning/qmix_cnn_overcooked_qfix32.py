        ...
        def _update_step(runner_state, unused):
            ...
            def _learn_phase(carry, _):
                ...
                def _agent_loss_fn(params):
                    ...
                    target_qvalues = jax.lax.stop_gradient(target_qvalues)
                    loss = jnp.mean((chosen_qvalues - target_qvalues) ** 2)

                    return loss
                
                agent_loss, agent_grads = jax.value_and_grad(_agent_loss_fn, has_aux=False)(
                    train_state.params
                )
                ...
                agent_grads = {
                    ...
                    'fixee' : jax.tree.map(lambda x: jnp.zeros_like(x), agent_grads['fixee'])
                }
