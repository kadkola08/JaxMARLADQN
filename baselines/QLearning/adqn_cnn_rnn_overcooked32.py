...
class CNNRNNQNetwork(nn.Module):
    ...
    def __call__(self, hidden, obs, dones):
        ...
        # embedding = CNN(num_features=32, num_agents=1)(obs_reshaped)
...
class MixingNetwork(nn.Module):
    ...
    def __call__(self, hidden, joint_observation, state, joint_action, dones):
        ...
        # joint_observation = CNN(num_features=32, num_agents=2)(joint_observation)
        ...
        # state = CNN(num_features=32, num_agents=2)(state)
	    # joint_observation shape (NUM_STEPS * BUFFER_BATCH_SIZE, EMBEDDING_SIZE)
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _learn_phase(carry, _):
                ...
                def _mixer_loss_fn(params):
                    ...
                    channels_per_agent = state_flat.shape[-1]
        ...
        def get_greedy_metrics(rng, train_state):
            ...
            hstate = ScannedRNN.initialize_carry(
                ...
                # 512, len(env.agents), config["TEST_NUM_ENVS"]
        ...
        init_hs = ScannedRNN.initialize_carry(
            ...
            # 512, len(env.agents), config["NUM_ENVS"]
        )
