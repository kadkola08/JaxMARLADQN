...
MAP_NAME_TO_SCENARIO = {
    ...
    "smacv2_5_units_fix_units": Scenario(jnp.zeros((10,), dtype=jnp.uint8), 5, 5, True, False),
    "smacv2_5_units_fix_pos_and_units": Scenario(jnp.zeros((10,), dtype=jnp.uint8), 5, 5, False, False),
    ...
    "smacv2_10_units_fix_units": Scenario(jnp.zeros((20,), dtype=jnp.uint8), 10, 10, True, False),
    "smacv2_10_units_fix_pos_and_units": Scenario(jnp.zeros((20,), dtype=jnp.uint8), 10, 10, False, False),
